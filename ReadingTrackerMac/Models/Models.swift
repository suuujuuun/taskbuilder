...
final class Document {
    ...
    init(title: String, totalPages: Int, targetDate: Date, difficulty: Int? = nil, link: String? = nil, orderIndex: Int = 0) {
        self.title = title
...
final class ProgressLog {
    ...
    init(date: Date = Date(), page: Int, topic: String, satisfaction: Int? = nil) {
        self.date = date
        self.page = page
        self.topic = topic
...
struct BackupDocument: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, totalPages, targetDate, difficulty, link, orderIndex, progressLogs
    }

    init(id: FlexibleID? = nil, title: String? = nil, totalPages: Int? = nil, targetDate: Date? = nil, difficulty: Int? = nil, link: String? = nil, orderIndex: Int? = nil, progressLogs: [BackupProgressLog]? = nil) {
        self.id = id; self.title = title; self.totalPages = totalPages; self.targetDate = targetDate; self.difficulty = difficulty; self.link = link; self.orderIndex = orderIndex; self.progressLogs = progressLogs
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        if self.totalPages == nil, let d = try? container.decodeIfPresent(Double.self, forKey: .totalPages) { self.totalPages = Int(d) }
...
struct BackupProgressLog: Codable {
    ...
    init(id: FlexibleID? = nil, date: Date? = nil, page: Int? = nil, topic: String? = nil, satisfaction: Int? = nil, documentId: FlexibleID? = nil) {
    ...
    init(from decoder: Decoder) throws {
        ...
        if self.page == nil, let d = try? container.decodeIfPresent(Double.self, forKey: .page) { self.page = Int(d) }
